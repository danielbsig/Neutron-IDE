...
urlpatterns = patterns('ide.views',
  ...
  url('^compile/$', 'compile', name='ide-compile'),
  url('^run/$', 'run', name='ide-compile'),
  url('^debug/$', 'debug', name='ide-debug'),
  url('^step/$', 'step', name='ide-step'),
  url('^stepi/$', 'stepi', name='ide-stepi'),
  url('^cont/$', 'cont', name='ide-cont'),
  ...
  url('^terminal/$', 'terminal', name='ide-terminal'),
