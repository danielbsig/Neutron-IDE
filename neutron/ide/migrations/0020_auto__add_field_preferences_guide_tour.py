...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Preferences.guide_tour'
        db.add_column('ide_preferences', 'guide_tour', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Preferences.guide_tour'
        db.delete_column('ide_preferences', 'guide_tour')
    ...
    models = {
        ...
        'auth.user': {
            ...
            'date_joined': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 28, 9, 32, 6, 549940)'}),
            ...
            'last_login': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2012, 6, 28, 9, 32, 6, 549860)'}),
        ...
        'ide.preferences': {
            ...
            'guide_tour': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
